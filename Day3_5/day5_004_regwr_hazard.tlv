...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         $imm[31:0] = $is_i_instr ? { {21{$instr[31]}}, $instr[30:20] } :
                      ...
                      $is_b_instr ? { {21{$instr[31]}}, $instr[7], $instr[30:25], $instr[11:8]} :
                      $is_u_instr ? { {13{$instr[31]}}, $instr[30:12]} :
                      $is_j_instr ? { {13{$instr[31]}}, $instr[19:12], $instr[20], $instr[30:21]} :
                      0;
      ...
      @2
         ...
         ?$rs1_valid
            ...
            $ooooo_s1 = >>2$rd_valid && (>>2$rd[4:0] == $rs1[4:0]);
            $ooooo_res1[31:0] = >>2$result[31:0];
            //$src1_value[31:0] = (>>1$rd[4:0] == $rs1[4:0]) ? >>2$result[31:0]: $rf_rd_data1[31:0];
            //$src1_value[31:0] = $rf_rd_data1[31:0];
            $src1_value[31:0] = $ooooo_s1 ? $ooooo_res1[31:0]: $rf_rd_data1[31:0];

         $rf_rd_en2 = $rs2_valid ? 1: 0;
         ?$rs2_valid
            $rf_rd_index2[4:0] = $rs2[4:0];
            $ooooo_s2 = >>2$rd_valid && (>>2$rd[4:0] == $rs2[4:0]);
            $ooooo_res2[31:0] = >>2$result[31:0];
            //$src2_value[31:0] = (>>1$rd[4:0] == $rs2[4:0]) ? >>2$result[31:0]: $rf_rd_data2[31:0];
            //$src2_value[31:0] = $rf_rd_data2[31:0];
            $src2_value[31:0] = $ooooo_s2 ? $ooooo_res2[31:0]: $rf_rd_data2[31:0];
      @3   
   ...
   //*passed = *cyc_cnt > 100;
   *passed = |cpu/xreg[10]>>8$value == (1+2+3+4+5+6+7+8+9);
   *failed = 1'b0;
