...
\TLV
   ...
   m4_asm(AUIPC, r20, 010000000000)     // Add 1024 to the current address of this instruction
   m4_asm(ADD, r0, r0, r0)

   // Optional:
   //m4_asm(JAL, r7, 00000000000000000000) // Done. Jump to itself (infinite loop). (Up to 20-bit signed immediate plus implicit 0 bit (unlike JALR) provides byte address; last immediate bit should also be 0)
   m4_asm(JALR, r7, r0, 00000000000000000000)
   ...
   |cpu
      ...
      @3   
         ...
         $rf_wr_en = ($rd_valid && $valid && $rd != 5'b0) || >>2$valid_load || >>2$valid_jump;
         ?$rd_valid
            $rf_wr_index[4:0] = $valid ? $rd[4:0] : >>2$rd[4:0];
            $rf_wr_data[31:0] = $valid ? $result[31:0] : >>2$valid_load ? >>2$ld_data[31:0] : >>2$pc[31:0] + 32'd4;
         ...
         $taken_br = $is_blt && (($src1_value <  $src2_value) ^ ($src1_value[31] != $src2_value[31])) ? 1 :
                     ...
                     $is_beq  && ($src1_value == $src2_value) ? 1 :
         ...
         ?$taken_br
         $br_tgt_pc[31:0] = $is_jal || $is_blt || $is_bne || $is_beq || $is_bge || $is_bltu || $is_bgeu ? $pc[31:0] + $imm[31:0] :
                            $is_jalr ? $src1_value[31:0] + $imm[31:0] :
                            $is_load ? $pc[31:0] + 4 :
                            0;
